      ...
      {flagship && (
        <div className="group relative max-w-6xl mx-auto">
          ...
          <Card className="relative overflow-hidden bg-background/50 border-white/10 rounded-[2rem] flex flex-col lg:flex-row items-stretch min-h-fit lg:min-h-[500px]">
            ...
            <div className="w-full lg:w-[50%] relative min-h-[300px] lg:min-h-full overflow-hidden border-t lg:border-t-0 lg:border-l border-white/10 group-hover:border-primary/30 transition-colors">
              <img
                src={flagship.image}
                alt={flagship.title}
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-background/80 via-transparent to-transparent lg:hidden block" />
              
              {/* Interactive Glass Tag */}
              <div className="absolute bottom-6 right-6 backdrop-blur-md bg-white/5 border border-white/10 px-4 py-2 rounded-full opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
                <p className="text-[10px] text-white font-medium tracking-[0.2em] uppercase">Built with {flagship.tags[0]} & {flagship.tags[1]}</p>
              </div>
            </div>
          </Card>
        </div>
